...
import { client } from "@/lib/api/directus";
...
export default async function CTACard({
  ...
  return (
    <div>
      <div className="relative my-7 block overflow-hidden rounded-md bg-slate-100 px-6 py-10">
        {/* Overlay */}
        ...
        <div className="relative z-20">
          ...
          >
            ...
            />
            <button className="whitespace-nowrap rounded-md bg-primary-color px-3 py-2 font-semibold text-button-primary-color hover:bg-secondary-color">
          ...
          <div className="mt-5 text-neutral-700">
            ...
            <span className="mx-2 rounded-md bg-primary-color px-2 py-1 text-sm font-semibold text-button-primary-color">
              {subscribersCount}
            </span>
